...
Http::group(ADMIN, function(){
    ...
    Http::get('/login', 'Admin\AuthController@login')->middleware([Login::class])->name('staff.login'); // Done
    Http::post('/login', 'Admin\AuthController@login')->middleware([Login::class]);
