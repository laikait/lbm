...
class DomainSchema
{
    ...
    {
        Schema::on()->createIfNotExists('domains', function (Blueprint $t) {
            $t->bigId('domain_id');
            $t->string('domain');
            ...
            $t->string('epp_code')->nullable()->comment('encrypted');
            $t->serialize('registrar_data')->nullable()->comment('Registrar Specific Metadata');
