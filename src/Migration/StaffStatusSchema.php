...
class StaffStatusSchema
{
    ...
    {
        Schema::on()->createIfNotExists('staff_statuses', function (Blueprint $t) {
            $t->id('status_id');
    ...
    public function default(): void
    {
        ...
        $model->transaction(function (StaffStatusModel $m) {
            try {
                ...
                throw new MigrationException("Unable to Insert Default Into 'staff_statuses. {$e->getMessage()}", (int) $e->getCode(), $e);
            }
        });
        return;
    }
